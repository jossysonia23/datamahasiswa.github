...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if (isset($_GET['npm'])) {
			...
			$select = mysqli_query($link, "SELECT * FROM tb_biodata WHERE npm='$npm'") or die(mysqli_error($link));
		...
		if (isset($_POST['submit'])) {
			...
			$sql = mysqli_query($link, "UPDATE tb_biodata SET npm='$npm', nama='$nama', tempat_lahir='$tempat', tanggal_lahir='$tanggal', jenis_kelamin='$jk', alamat='$alamat', kode_pos='$kodepos' WHERE npm='$npm'") or die(mysqli_error($link));
		...
		<form action="edit.php?npm=<?php echo $npm; ?>" method="post">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="number" name="npm" class="form-control" size="4" value="<?php echo $data['npm']; ?>" readonly required>
				</div>
			</div>
			<div class="form-group row">
