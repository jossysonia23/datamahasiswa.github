	...
	<div class="container" style="margin-top:20px">
		...
		if (isset($_POST['simpan'])) {
			...
			if (mysqli_num_rows($cek) == 0) {
				$sql = mysqli_query($link, "INSERT INTO tb_biodata(npm, nama, tempat_lahir, tanggal_lahir, jenis_kelamin, alamat, kode_pos) VALUES('$npm', '$nama', '$tempat', '$tanggal','$jk','$alamat','$kodepos')") or die(mysqli_error($link));
